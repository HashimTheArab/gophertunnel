...
type PrimitiveShape struct {
	...
	// PrimitiveShapeDataPayload types the field as an ActorUniqueID, a signed varint, while documenting the value it
	// carries as "Runtime ID of the entity this shape is attached to".
...
func (x *PrimitiveShape) Marshal(io IO) {
	...
	OptionalFunc(io, &x.AttachedToEntityID, func(id *int64) { ActorRuntimeIDInt64(io, id) })

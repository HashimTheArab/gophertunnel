...
func (x *Command) Marshal(io IO) {
	...
	io.Int32(&x.AliasesOffset)
	FuncSliceLimits(io, &x.ChainedSubcommandOffsets, io.Varuint32, 0, 250, io.Uint32)
...
func (x *CommandEnum) Marshal(io IO) {
	io.String(&x.Type)
	FuncSlice(io, &x.ValueIndices, io.Varuint32, io.Uint32)
}
...
func (x *CommandEnumConstraint) Marshal(io IO) {
	io.Uint32(&x.EnumValueIndex)
	io.Uint32(&x.EnumIndex)
	FuncSliceLimits(io, &x.Constraints, io.Varuint32, 0, 250, io.Uint8)
}

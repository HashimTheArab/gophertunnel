...
const (
	...
	// DefaultResourcePackChunkSendDelay is the default delay between ResourcePackChunkData packets. The
	// client bounds the transfer itself by keeping at most DefaultResourcePackMaxInFlightChunks requests
	// outstanding, so chunks are not paced by default.
